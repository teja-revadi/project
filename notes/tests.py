...
class NoteViewSetTestCase(TestCase):
    ...
    def test_get_note_by_pk(self):
        ...
        # 2nd test case, invalid notes id
        client = APIClient()
        ...
        # 3rd test case
        # exising notes id from fixtures
        client = APIClient()
    ...
    def test_filter_notes_by_title(self):
        ...
        # response ok if number of filtered_notes are 2
        self.assertEqual(len(filtered_notes), 2)
